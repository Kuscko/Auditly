"""AWS VPC evidence collector for RapidRMF.
            ...
            for page in paginator.paginate():
                for endpoint in page.get("VpcEndpoints", []):
                    endpoints.append({
                        ...
                        "security_group_ids": [sg.get("GroupId") for sg in endpoint.get("Groups", [])],
                        "policy_document": endpoint.get("PolicyDocument"),
                        "private_dns_enabled": endpoint.get("PrivateDnsEnabled"),
                        "tags": {t.get("Key"): t.get("Value") for t in endpoint.get("Tags", [])},
                    })
