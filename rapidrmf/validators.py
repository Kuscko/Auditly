...
FAMILY_PATTERNS = {
    ...
    "CM": FamilyPattern(
        family="CM",
        required_any=["terraform-plan", "ansible-playbook", "cloudformation-template", "github-workflow"],
    ...
    "PE": FamilyPattern(
        family="PE",
        required_any=["physical-security-policy", "datacenter-attestation", "facility-documentation"],
        required_all=[],
    ...
    "PM": FamilyPattern(
        family="PM",
        required_any=["program-management-plan", "governance-documentation", "policy-documentation"],
        required_all=[],
...
class ComplianceValidator:
    ...
    def validate(self, evidence: Dict[str, Any], system_state: Optional[Dict[str, Any]] = None) -> ValidationResult:
        """
...
class ComplianceValidator:
    ...
    def validate(self, evidence_keys: Set[str], evidence_details: Dict[str, Any]) -> ValidationResult:
        """
...
def validate_controls(
    ...
    for cid in control_ids:
        ...
        if req:
            ...
            results[cid] = validator.validate(evidence_keys, evidence)
        else:
