...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_evidence_manifests_created_at'), 'evidence_manifests', ['created_at'], unique=False)
    op.create_index(op.f('ix_evidence_manifests_system_id'), 'evidence_manifests', ['system_id'], unique=False)
    ...
    op.create_index(op.f('ix_control_requirements_control_id'), 'control_requirements', ['control_id'], unique=False)
    op.create_table('evidence_manifest_entries',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_evidence_manifest_entries_evidence_id'), 'evidence_manifest_entries', ['evidence_id'], unique=False)
    op.create_index(op.f('ix_evidence_manifest_entries_manifest_id'), 'evidence_manifest_entries', ['manifest_id'], unique=False)
    ...
    sa.Column('system_id', sa.Integer(), nullable=False),
    sa.Column('control_id', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('PASS', 'FAIL', 'INSUFFICIENT_EVIDENCE', 'UNKNOWN', name='validationstatus'), nullable=False),
    ...
    op.create_index(op.f('ix_validation_results_control_id'), 'validation_results', ['control_id'], unique=False)
    op.create_index(op.f('ix_validation_results_status'), 'validation_results', ['status'], unique=False)
    op.create_index(op.f('ix_validation_results_system_id'), 'validation_results', ['system_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_evidence_manifest_entries_manifest_id'), table_name='evidence_manifest_entries')
    op.drop_index(op.f('ix_evidence_manifest_entries_evidence_id'), table_name='evidence_manifest_entries')
