"""AWS RDS evidence collector for auditly.
                    ...
                    instances.append(
                        {
                            ...
                            "enable_cloudwatch_logs_exports": instance.get(
                                "EnableCloudwatchLogsExports", []
                            ),
                            "db_parameter_group": instance.get("DBParameterGroups", [{}])[0].get(
                            ...
                            "db_subnet_group": instance.get("DBSubnetGroup", {}).get(
                                "DBSubnetGroupName"
                            ),
                            "enable_iam_database_authentication": instance.get(
                            ...
                            "subnets": [
                                {
                                    ...
                                    "availability_zone": s.get("SubnetAvailabilityZone", {}).get(
                                        "Name"
                                    ),
