...
<html>
<head>
    <title>auditly Engineer Report</title>
    <style>
...
<body>
    <div class="container">
    <div class="header">
        <h1>auditly Compliance Validation Report</h1>
...
<html>
<head>
    <title>auditly ATO Auditor Report</title>
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        body {{
            font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;
...
<body>
    ...
    <div class="section">
        ...
        <p style="color: #666; font-size: 13px; margin-top: 20px; padding-top: 20px; border-top: 1px solid #e0e0e0;">
            This report is generated automatically by auditly and includes comprehensive evidence traceability.
